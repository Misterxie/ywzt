<template>
    <div>
        <p :class="className" :style="{textAlign: 'center', color: color, fontSize: countSize, fontWeight: countWeight}" style="position:relative;right:100%;top:-4px;"><span v-cloak :id="idName" style="letter-spacing: 1px">{{ startVal }}</span><span>{{ unit }}</span></p>
